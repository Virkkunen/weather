...
const Footer = () => {
  return (
    <footer className='fixed bottom-0 bg-mantle flex p-4 w-full justify-between content-baseline shadow-md text-sm md:relative md:row-start-3 md:rounded-lg md:flex md:flex-row md:justify-evenly md:p-4 md:w-1/2 md:mx-auto md:shadow-lg'>
      <a
